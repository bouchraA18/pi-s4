...
useEffect(() => {
  ...
  const rechercher = async () => {
    ...
    setCurrentPage(1);
    const params = {};
    if (selectedLocalisation) params.localisation = selectedLocalisation;
              ...
              {showFiltres && suggestionsNom.length === 0 && (
                ...
                >
                  <div style={{ marginBottom: "1rem" }}>
                    ...
                    {[t("recherche.primaire"), t("recherche.secondaire"), t("recherche.superieure")].map(
                      (n, index) => (
                        <div
                          key={n}
                          onClick={() => {
          ...
          <div style={{ display: "flex", gap: "2rem", padding: "0 1rem 2rem" }}>
              ...
              <div style={{ flex: 1, overflowY: "auto", paddingRight: "1rem" }}>
                {paginated.map((e) => (
                  ...
                  >
                    ...
                    <p style={{ margin: "0.5rem 0" }}>
                      <strong>{t("results.ville")}</strong> {e.localisation?.ville}
                    </p>
                    <p style={{ margin: "0.5rem 0" }}>
            ...
            >
              <MapContainer style={{ width: "100%", height: "100%" }} zoom={12}>
                ...
                />
                <FitBounds positions={etabs.map(e => [e.localisation?.latitude, e.localisation?.longitude])} />
                {etabs.map((e) => (
